      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            console.log(_context.t0); // alert(error.response.data.message)
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    /*, {icon: greenIcon}*/
    ).addTo(map).bindPopup("<h1>Day ".concat(loc.day, ": ").concat(loc.description, "</h1>"), {
      autoClose: false
    }).openPopup();
  });
  var bounds = L.latLngBounds(points).pad(0.5);
  map.fitBounds(bounds); // map.scrollWheelZoom.disable()
};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            stripe = Stripe('pk_test_51KnlGKJKEk2EsCP98IJqG3jxymjj3Wwukr9S6jXfxADyy42GVOnx4i757lDtFvL8tv6wHYECNG2mIQfk2w5gWpCL00WPMR6a8Q');
            _context.prev = 1;
            _context.next = 4;
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processing...'; // Tour id is stored in the button's data attribute (tour-id becomes tourId)
